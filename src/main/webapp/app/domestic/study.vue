...
<div id="bg">
    <b-row>
    <b-col>
      <h2 class="down1">前行之迹：国内升学</h2>
      <h2>
        <b-button variant="info" class="pull-right down2" v-b-modal.modal-1>我要求助/分享</b-button>
...
<script>
  export default {
    data() {
      return {
        items: [
          { title: "SE@NJU夏令营面试指南", last_reply_time: '2019.11.23', author: 'Macdonald' },
          { title: "北大信科,上交软院夏令营感想", last_reply_time: '2019.11.23', author: 'Shaw' },
          { title: "国内CV方向较强的实验室介绍", last_reply_time: '2019.11.23', author: 'Wilson' },
          { title: "南大lamda组面试感想", last_reply_time: '2019.11.23', author: 'Carney' }
        ],
        form: {
          title: '',
          conetnt: '',
